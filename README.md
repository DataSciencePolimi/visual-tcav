...
Based on:
<!-- > De Santis*, Campi*, Bianchi, Brambilla, *Visual-TCAV: Concept-based Attribution and Saliency Maps for Post-hoc Explainability in Image Classification*, 2025. [arXiv:2411.05698](https://arxiv.org/abs/2411.05698) -->
> De Santis*, Campi*, Bianchi, Brambilla, *Visual-TCAV: Concept-based Attribution and Saliency Maps for Post-hoc Explainability in Image Classification*, **Transactions on Machine Learning Research (TMLR), 2025**. [OpenReview](https://openreview.net/forum?id=SLh00W5rhu)
